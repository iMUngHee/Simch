...
const Home: NextPage = () => {
  return (
    <Layout title="FakeBlog" description="하루 하루는 성실히, 인생은 되는대로">
      <Container>
        ...
        <div className="mt-5 flex flex-col gap-5 px-3">
          <div>
            <h2 className="text-3xl font-bold">Grizzly</h2>
            <p className="mt-1">Bear ( Animal / Mammal ) </p>
            <p className="">weBareBears@Siberia.forest </p>
          ...
          <div>
            ...
            <Paragraph style="flex flex-col">
              <span className="font-bold">- 조선 (1392.02 ~ 1910.07)</span>
              <span className="font-bold">- 대한민국 (1945.08 ~ )</span>
            </Paragraph>
          </div>
          <div>
            <HeadLine>Skills</HeadLine>
            <Paragraph style="flex flex-col text-xl gap-4">
              <Skill title="React" progress={`w-[100%]`} color="text-cyan-400">
                <ReactIcon />
              </Skill>
              <Skill
                title="JavaScript"
              ...
              <Skill title="Vue" progress={`w-[100%]`} color="text-green-400">
                <Vue />
              </Skill>
            </Paragraph>
          </div>
          <div>
            ...
            <Paragraph style="flex flex-col">
              ...
              <span className="font-bold">- Swimming 🏊‍♂️</span>
            </Paragraph>
          </div>
          <div>
